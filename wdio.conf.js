exports.config = {
    ...
    logLevel: 'verbose',
    //
    // Pipe WebdriverIO logs into a file. Takes a string value for the path and filename.
    // logOutput: './logs',
    //
    ...
    /**
     * Hook that gets executed before the suite starts. Every "describe" block is a suite.
    ...
    // },
    /**
     * Hook that gets executed after the suite has ended. Every "describe" block is a suite.
     * @param {Object} suite suite details
     */
